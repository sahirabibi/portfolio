		...
		<section className='about-container'>
			<div className='right section-info about-me'>
				...
				<p className='about-info'>
					I am currently based in Brooklyn, NY. I am a software developer, trained
					researcher, and avid reader and writer with a passion for finding
					creative and analytical solutions to life's many problems. I am trained in
					quantitative and qualitative research with the goal to generate
					sophisticated solutions. I am motivated by the story that each of our
